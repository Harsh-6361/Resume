      ...
      <div className="grid grid-cols-3 min-h-screen">
        ...
        <div className="bg-gradient-to-b from-purple-600 to-pink-600 text-white p-6">
          ...
          {data.certificates.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold mb-4 text-purple-100">Certifications</h2>
        ...
        <div className="col-span-2 p-8">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                {data.experience.map((exp) => (
                  <div key={exp.id} className="relative pl-6 border-l-4 border-purple-200">
          ...
          {data.activities.length > 0 && (
            <section>
              <h2 className="text-2xl font-bold text-purple-600 mb-6">Activities & Achievements</h2>
              <div className="space-y-3">
